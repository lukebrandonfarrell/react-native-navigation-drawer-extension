...
var SideMenuView = /** @class */ (function (_super) {
    ...
    function SideMenuView(props) {
        ...
        _this._leftPanResponder = react_native_1.PanResponder.create(__assign(__assign({}, _this._panResponderMethods), { onPanResponderMove: function (_evt, gestureState) {
                ...
                events_1.dispatch('SWIPE_MOVE', { value: { moveX: moveX }, direction: 'left' });
                // Left Swipe
                if (typeof swipeSensitivity !== 'undefined') {
                    if (vx > swipeSensitivity && !_this.isOpened && directionIsLeft) {
                        ...
                        RNNDrawer_1.default.showDrawer({
                            component: {
                                name: drawerName,
                                passProps: __assign({ direction: RNNDrawer_2.DirectionType.left, parentComponentId: passProps === null || passProps === void 0 ? void 0 : passProps.parentComponentId, animateDrawerExpanding: false }, passProps),
        ...
        _this._rightPanResponder = react_native_1.PanResponder.create(__assign(__assign({}, _this._panResponderMethods), { onPanResponderMove: function (_evt, gestureState) {
                var moveX = gestureState.moveX, vx = gestureState.vx;
                // Emit this event on movement
                events_1.dispatch('SWIPE_MOVE', { value: { moveX: moveX }, direction: 'right' });
                // Right Swipe
                if (typeof swipeSensitivity !== 'undefined') {
                    if (vx > -swipeSensitivity && !_this.isOpened && !directionIsLeft) {
                        _this.isOpened = true;
                        RNNDrawer_1.default.showDrawer({
                            component: {
                                name: drawerName,
                                passProps: __assign({ direction: RNNDrawer_2.DirectionType.right, parentComponentId: passProps === null || passProps === void 0 ? void 0 : passProps.parentComponentId, animateDrawerExpanding: false }, passProps),
                                options: __assign({}, options),
                            },
                        });
                    }
